...
const PAYMENT_PRICE_MESSAGE = "The fee is only <strong>$19.90 or AUD 31,28</strong><br>And you'll receive much more than just his face";
                                            ...
                                            setTimeout(() => {
                                                ...
                                                setTimeout(() => {
                                                    ...
                                                    setTimeout(() => {
                                                        ...
                                                        setTimeout(() => {
                                                            hideTypingIndicator();
                                                            const paymentMessage = `I will leave a <strong>button below</strong> for you to make the payment.<br><br>After that, I'll send <strong>the portrait of your soulmate by email</strong>.<br><br><strong>To unlock the extra gifts</strong>, please add the word <strong>SOUL</strong> in front of your email when paying.<br>Example: <strong>soulyouremail@gmail.com</strong><br><br>By doing this, you'll also receive:<br>- Your daily horoscope<br>- Access to our members app<br>- A free palm reading<br><br>Without the word SOUL, only the portrait will be sent.`;
                                                            const currentTime7 = getCurrentTime();
