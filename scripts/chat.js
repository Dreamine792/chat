...
const PAYMENT_PRICE_MESSAGE = "The fee is only <strong>$19.90 or ZAR 373,07</strong>";
                                            ...
                                            setTimeout(() => {
                                                ...
                                                setTimeout(() => {
                                                    ...
                                                    setTimeout(() => {
                                                        ...
                                                        setTimeout(() => {
                                                            hideTypingIndicator();
                                                            const paymentMessage = `I will leave a <strong>button below</strong> for you to make the payment of the fee. After that, I will send the portrait of your soulmate by email and provide personal guidance over the next few months, so the universe can quickly manifest the person destined to have a special connection with you.<br><br><strong>Important:</strong> When entering your email, please add the word <strong>SOUL</strong> in front of it.<br><br>For example: <strong>soul+youremail@gmail.com</strong><br><br>This helps us identify that it's really you, prioritize the creation of your soulmate's portrait, and as a bonus, I'll also gift you a free palm reading.<br><br>`;
                                                            const currentTime7 = getCurrentTime();
